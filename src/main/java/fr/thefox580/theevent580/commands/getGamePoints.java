...
public class getGamePoints implements CommandExecutor {

    private final main plugin;
    private final main advMain;

    public getGamePoints(main plugin) {
        this.plugin = plugin;
        this.advMain = plugin;
    }
            ...
            if (player.isOnline()){
                ...
                if (commandSender instanceof Player){
                   ...
                   String message = Component.text("Player ")
                            ...
                            .append(Component.text(" currently has " + gamePointsPlayer + " game points", TextColor.color(255, 255, 255))))).toBuilder().build().content(); //Set custom message
